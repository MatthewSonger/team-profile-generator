        ...
        if (element.getRole() === 'Manager') {
            const card = `<div class="col">
                            ...
                            <div class="card-body bg-primary">
                                ...
                                <img src="./img/manager.svg" class="glyph"></img><h6 class="text-light">${element.getRole()}</h3>
                            </div>
            ...
            const card = `<div class="col">
                            ...
                            <div class="card-body bg-primary">
                                <h5 class="card-title text-light">${element.getName()}</h5>
                                <img src="./img/engineer.svg" class="glyph"></img><h6 class="text-light">${element.getRole()}</h3>
                            </div>
                            <div class="card-footer">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">Employee ID: ${element.getId()}</li>
            ...
            const card = `<div class="col">
                            ...
                            <div class="card-body bg-primary">
                                <h5 class="card-title text-light">${element.getName()}</h5>
                                <img src="./img/intern.svg" class="glyph"></img><h6 class="text-light">${element.getRole()}</h3>
                            </div>
                            <div class="card-footer">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">Employee ID: ${element.getId()}</li>
...
function generatePage(array) {
    ...
    <!DOCTYPE html>
        <html lang="en">
            ...
            <body>
                <nav class="bg-success text-light"><h2>Team Roster</h2></nav>
                <div class="container">
